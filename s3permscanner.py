...
from gen_names import newBucketNames
...
parser.add_argument('--version', required=False, dest='version',
...
parser.add_argument('-s','--is-subdomain', required=False, dest='isSubdomain', action='store_true',
                    help='(Switcher) If subdomain, then only names: "sub.domain.tld", "sub", "sub.domain", "sub-domain" & "subdomain" (Default: False)"')
